  ...
  return (
    <Provider store={store}>
      <RouterSelector history={history} location={props.location} context={props.context}>
        <Startup>
          <Switch>
            <Route exact path="/" component={() => <InputCategory />} />
            <Route exact path="/:category" component={() => <TasksList />} />
            <Route exact path="/:category/:timespan" component={() => <TasksList />} />
            <PrivateRoute exact path="/hidden-route" component={() => <InputCategory />} />
